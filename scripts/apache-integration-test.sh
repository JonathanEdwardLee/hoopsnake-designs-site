...
assert_body_contains "GET /" "My art project"
assert_body_contains "GET /" "How I Work"
assert_body_contains "GET /" "Pricing &amp; Scope"
assert_body_contains "GET /" "I'll follow up"
assert_body_contains "GET /" "https://github.com/JonathanEdwardLee"
assert_body_contains "GET /" "https://www.linkedin.com/in/thewordjonlee"
assert_body_contains "GET /" "G-X45GW26X65"
assert_body_contains "GET /" "hoopsnake-icon-32-v004.png"
assert_body_contains "GET /" "orpheus-play-main.webp"
assert_body_not_contains "GET /" "View Portfolio"
assert_body_not_contains "GET /" "orpheus-deck.webp"
